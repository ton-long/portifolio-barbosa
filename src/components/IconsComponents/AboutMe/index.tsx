  ...
  return (
    <div className={styles.mainAboutMe}>
      ...
      <p className={styles.aboutMeP}>
        ...
        soluções me trouxe mais próximo da área. Com o tempo, resolvi me aprofundar ainda mais e investi em
        diversos cursos, que me permitiram melhorar meus conhecimentos e me
        tornar um desenvolvedor melhor.
      </p>
      <hr className={styles.hr}/>
      <p className={styles.aboutMeP}>
        Hoje, a programação é algo que me apaixona a cada novo projeto, e estou
