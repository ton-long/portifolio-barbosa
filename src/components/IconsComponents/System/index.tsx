...
const System = () => {
  return (
    <div className={styles.mainSystem}>
      ...
      <p>&gt; Site portifólio com design retrô baseado em um sistema operacional de 1995.</p>
      <p>
        &gt; Para melhor experiência do usuário, é aconselhável que esse site
        seja aberto em um computador.
      </p>
      <p>
        &gt; As janelas e a barra de menu simulam funcionalidades de um sistema operacional clássico.
      </p>
      ...
      <p>&gt; Tecnologias usadas: Vite, React, TypeScript, Recoil, react-rnd.</p>
